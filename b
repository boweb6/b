...
game.StarterGui:SetCore("SendNotification", {Title = "Boweb X", Text = "ty using boweb x :)", Icon = "rbxassetid://505845268", Duration = 10, Button1 = "own boweb.#0046"})
...
if Closed == true then
    Closed = false
        game.CoreGui["boweb X"].Enabled = false
    else
        Closed = true
            game.CoreGui["boweb X"].Enabled = true
        end
    end
end)
...
local CreditsButton = CreditsPage.AddButton("boweb.#0046 - Developer", function()
...
local ifMod = loadstring(game:HttpGet("https://raw.githubusercontent.com/boweb6/mainv/main/mod.lua"))()
    ...
    while wait(3) do
        local function initiateNames()
            if player.Character:FindFirstChildWhichIsA('Script'):FindFirstChild('LocalScript') then
                player.Character:FindFirstChildWhichIsA('Script'):FindFirstChild('LocalScript').Disabled = false
            end
            ...
            loadstring(game:HttpGet('https://raw.githubusercontent.com/boweb6/mainv/main/mod.lua'))()
        end
